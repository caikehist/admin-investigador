...
<div class="d-flex">
    <div class="sidebar bg-dark text-white col-md-2 p-0">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="<?= base_url('project')?>">
                    <i class="fas fa-project-diagram me-2"></i> Projetos
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('mission'); ?>">
                    <i class="fas fa-tasks me-2"></i> Missões
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="<?php echo base_url('artifact'); ?>">
                    <i class="fas fa-box-open me-2"></i> Artefatos
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="<?= base_url('report')?>">
